...
(function () {
	...
	text_automatic_toggle.onclick = function () {
		...
		text_automatic_toggle.innerHTML = Game.CLICK_TO_ADVANCE ? "по кліку" : "автоматично";
	...
	var updateText = function () {
		...
		// What's the dialogue?
		var dialogue = Game.TEXT_SPEED < 80 ? "Так швидко" : "Так повільно";
	...
	subscribe("show_options_bottom", function () {
		...
		optionsDOM.setAttribute("past_intro", ALREADY_DID_INTRO ? "так" : "ні");
