...
b: Людино... ти допоможеш вгамувати цього вовка?
...
h: Окей. Здорові відносини з емоціями. Щоб побудувати відносини потрібно говорити. Давай поговорим.
...
h: Впродовж кількох днів дресирувальник поступово збільшує гучність, поки собака не подолає страх перед громом.
...
b: Незабаром ми будемо їсти солодощі, дивлячись ^вбивче порно^! 
...
h: Навіть якщо твоє скиглення лякає мене, ти просто намагаєшся оберігти мене {{_.thanks_for}}.
...
h: Камон, я просто вразлива студентка, а ти великий страшний вовк. Найгіршим що --
...
b: Я хочу переконатися, що ти задовільниш потребу належати комусь...

`bb({ eyes:"sad_u" });`

b: Але я хвилююсь, що якби хтось, коли-небудь знав нас - *реальних* – ми б усіх відлякали.
...
b: Звісно, я думаю... при найгіршому сценарії, ми можемо виїхати з міста і створити нове життя.
...
h: Одного дня, ми зможемо показувати людям наше я - зруйноване, але людське.
...
[Ми поломані. Давай виправимо це.](#act4_bad_fix)

[Ми поломані. Давай приймемо це.](#act4_bad_accept)
...
h: Якщо потрібно, ми можем отримати професійну допомогу - терапевта або психолога.
...
h: Але, ще досі є дешеві або безкоштовні варіанти:
...
b: Але... Я не справляюсь з цим, тому мені потрібно, щоб ти мене тренувала.
